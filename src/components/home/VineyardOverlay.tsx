...
export function VineyardOverlay() {
  return (
    <section className="relative min-h-[750px] lg:min-h-[85vh] w-full flex items-center overflow-hidden border-t border-b border-white/10 bg-[#050505]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-black to-transparent z-10" />
      </div>

      {/* Content Container: Full Width with Refined Side Padding */}
      <div className="relative z-20 w-full px-6 sm:px-12 lg:px-20 py-24 sm:py-32">
        <div className="max-w-2xl space-y-6">
          <h2 className="font-serif text-4xl sm:text-6xl lg:text-7xl text-white tracking-[0.14em] uppercase font-light leading-[1.1]">
            NATURE CREATES.<br />
            TIME PERFECTS.<br />
