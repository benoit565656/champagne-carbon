...
export function ManilaWineExclusivity() {
  return (
    <section className="w-full bg-[#000000] py-24 sm:py-32 border-t border-white/5">
      <div className="w-full max-w-5xl mx-auto px-6 text-center space-y-5">
        <p className="font-serif text-[11px] uppercase tracking-[0.4em] text-[#c9a24b] font-medium">
          THE HOUSE
        </p>

        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 font-serif text-lg sm:text-2xl lg:text-3xl text-white tracking-[0.22em] uppercase font-light">
