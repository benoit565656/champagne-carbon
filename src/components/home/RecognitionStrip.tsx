...
export function RecognitionStrip() {
  return (
    <section className="w-full bg-[#000000] py-20 sm:py-24 border-b border-white/10">
      <div className="w-full max-w-[1760px] mx-auto px-6 sm:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-4 text-center lg:text-left">
            ...
            <ul className="space-y-2.5 text-[11px] text-[#ece9e2]/80 tracking-wider uppercase font-light">
          ...
          <div className="flex items-center justify-center lg:border-l border-white/10 lg:pl-8 py-4">
            <div className="relative w-32 h-32 sm:w-36 sm:h-36 hover:scale-105 transition-transform duration-300">
              <Image
