...
export function CuveeShowcase() {
  ...
  // Exact order from champagnecarbon.com screenshot 5:
  // 1. Carbon Brut, 2. Carbon Rosé, 3. Blanc de Blancs 2019, 4. Blanc de Noirs 2009
  const orderedIds = [
    'carbon-brut',
    'carbon-rose',
    'carbon-blanc-de-blancs-grand-cru-2019',
    'carbon-blanc-de-noirs-vintage-2009'
  ];
  ...
  // Concise format tags that never wrap or break
  ...
  return (
    <section className="w-full bg-[#000000] py-24 sm:py-36 border-b border-white/5">
      <div className="w-full max-w-[1760px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        {/* Section Heading matching Champagne Carbon screenshot 4 */}
        ...
        {/* 4 Majestic Columns on Pure Black (No card boxes, matching screenshot 5) */}
