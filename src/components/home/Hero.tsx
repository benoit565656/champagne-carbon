  ...
  return (
    <div className="relative w-full bg-[#050505]">
      ...
      <section className="relative min-h-[92vh] sm:min-h-screen w-full flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-20 w-full px-6 sm:px-12 lg:px-20 pt-28 sm:pt-36 pb-16 flex-grow flex flex-col justify-between">
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <h1 className="font-serif text-4xl sm:text-6xl lg:text-7xl text-white tracking-[0.14em] uppercase font-light leading-[1.08]">
              THE WORLD&apos;S FIRST<br />
              CHAMPAGNE<br />
              SEALED IN CARBON FIBER
            </h1>

            <p className="text-xs sm:text-sm text-[#ece9e2]/80 max-w-lg font-light leading-relaxed tracking-wide pt-2">
          ...
          {/* Stacked Partner Badges Strip on Lower Left (Matching Screenshot 1) */}
          <div className="pt-16 sm:pt-24 space-y-3">
            <div className="flex items-center gap-3">
              <span className="font-serif text-xs uppercase tracking-[0.2em] text-white font-medium">BUGATTI</span>
              <span className="text-[10px] text-white/30">&bull;</span>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#c9a24b]">OFFICIAL CHAMPAGNE</span>
            </div>

            <div className="flex items-center gap-3">
              <span className="font-serif text-xs uppercase tracking-[0.2em] text-white font-medium">LAMBORGHINI</span>
              <span className="text-[10px] text-white/30">&bull;</span>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#c9a24b]">OFFICIAL PARTNER</span>
            </div>

            <div className="flex items-center gap-3">
              <span className="font-serif text-xs uppercase tracking-[0.2em] text-white font-medium">DOUBLE GOLD</span>
              <span className="text-[10px] text-white/30">&bull;</span>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#c9a24b]">GILBERT &amp; GAILLARD 2026</span>
            </div>

            <div className="flex items-center gap-3">
              <span className="font-serif text-xs uppercase tracking-[0.2em] text-white font-medium">FORMULA 1</span>
              <span className="text-[10px] text-white/30">&bull;</span>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#c9a24b]">OFFICIAL CHAMPAGNE 2017&ndash;2020</span>
            </div>
          </div>
      ...
      <section className="relative z-20 w-full border-t border-b border-white/10 bg-[#050505] py-16 sm:py-20 px-6 sm:px-12 lg:px-20">
        <div className="w-full max-w-[1720px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 text-center">
