              ...
              >
                ...
                <div className="w-full space-y-4 flex flex-col justify-between flex-grow">
                  ...
                  <div className="pt-2 space-y-1.5">
                    ...
                    <div className={`grid gap-1.5 ${product.variants.length > 1 ? 'grid-cols-2' : 'grid-cols-1'}`}>
                      {product.variants.map((v, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`h-9 px-1 flex flex-col items-center justify-center text-[9px] font-mono tracking-wider uppercase transition-all border ${
                              isActive
